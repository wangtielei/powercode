...
class Bugfree
{
    ...
    function connect()
    {
        ...
        //$dbconn = new Database($this->configs[$sectionName]["server"],$this->configs[$sectionName]["username"], $this->configs[$sectionName]["password"],$this->configs[$sectionName]["database"]);
        //$dbconn->connect();
